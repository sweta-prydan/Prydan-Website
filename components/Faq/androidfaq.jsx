        ...
        <Accordion defaultActiveKey="0" flush>
            <Accordion.Item eventKey="0"
                ...
                <Accordion.Header style={{ padding: "15px 20px" }}>
                    Is building a web app in Android is a secure choice?
                </Accordion.Header>
                <Accordion.Body>
                    Absolutely yes! Angular is a Java framework that works as per REST, which helps you to build high traffic applications keeping all the data secured and encrypted.
                </Accordion.Body>
            </Accordion.Item>
            ...
            <Accordion.Item eventKey="3" style=
                ...
                <Accordion.Header style={{ padding: "15px 20px" }}>
                    How will you manage the code in my Android project?
                </Accordion.Header>
                <Accordion.Body>
                    We use Github for source code management and version control. Our Android developers will regularly push the code so you can review all the commits and manage them easily.
                </Accordion.Body>
            </Accordion.Item>
            ...
            <Accordion.Item eventKey="4" style=
                ...
                <Accordion.Header style={{ padding: "15px 20px" }}>
                    May I test your Android developer's expertise and industry experience?</Accordion.Header>
                <Accordion.Body>
                    We have incredibly talented Android developers who have in-depth knowledge and extensive experience in building real-time and dynamic apps using Angular. Hire Angular developer from us for top-grade Angular development services to achieve desired business results.
                </Accordion.Body>
            </Accordion.Item>
        </Accordion>
