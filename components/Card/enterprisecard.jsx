    ...
    return <div>
        <div className='container'
            ...
            <h1 className='h1'
                ...
                As Enterprise Application Development Services Company <br />
                our Offerings</h1>
        </div>
            ...
            <Card border="danger" className='shadow p-3 mb-5 bg-white rounded'
                ...
                <Card.Body>
                    <Card.Title
                        ...
                        Enterprise App Consulting</Card.Title>
                    <Card.Text>
                ...
                <Card border="info" className='shadow p-3 mb-5 bg-white rounded'
                    ...
                    <Card.Body>
                        <Card.Title
                            ...
                            B2B Mobile Application Development</Card.Title>
                        <Card.Text>
            ...
            <Card border="warning" className='shadow p-3 mb-5 bg-white rounded'
                ...
                <Card.Body>
                    <Card.Title
                        ...
                        Enterprise Application Integration</Card.Title>
                    <Card.Text>
                ...
                <Card border="primary" className='shadow p-3 mb-5 bg-white rounded'
                    ...
                    <Card.Body>
                        <Card.Title
                            ...
                            Legacy Application Modernization</Card.Title>
                        <Card.Text>
            ...
            <Card border="danger" className='shadow p-3 mb-5 bg-white rounded'
                ...
                <Card.Body>
                    <Card.Title
                        ...
                        Enterprise Application Testing</Card.Title>
                    <Card.Text>
