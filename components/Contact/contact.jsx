        ...
        if (!formValid) {
            ...
            return (
                <>
                    ...
                    <div className="card shadow-sm px-5 mb-3 py-4 mx-5 bg-info">
                        ...
                        <div className="card-body">
                            <form action="/" onSubmit={(e) => this.handleSubmit(e)} 
                                ...
                                <div className="form-group">
                                    <label className="mb-1">Your name<span className="text-danger">*</span></label>
                                ...
                                <div className="form-group">
                                    <label className="mb-1">Your email<span className="text-danger">*</span></label>
                                ...
                                <p className="text-center mb-1 pt-4">
                                    <input type="submit"
                                        className="btn btn-outline-danger text-uppercase rounded-pill"
                                        value="Send"
                                        style={{
                                            marginTop: "30px",
                                            fontWeight: "600",
